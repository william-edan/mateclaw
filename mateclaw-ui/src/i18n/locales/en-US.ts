export default {
  ...
  settings: {
    ...
    model: {
      ...
      managedKeyHint: 'Managed by the platform and cannot be changed',
  ...
  wiki: {
    ...
    embeddingUnavailable: {
      ...
      banner: 'No usable embedding model is available, so this knowledge base cannot be built. Go to Settings → Models → Embedding to add one and make sure its provider has passed the connection test (shows "Ready").',
      toast: 'Configure a usable embedding model and make sure its provider is Ready first',
    },
    materialTitle: 'Title',
  ...
  enterprise: {
    ...
    contactCta: 'Contact us to tailor your own enterprise scenario',
    contactModal: {
      title: 'Contact Us',
      desc: 'Scan the QR code to reach our team and tailor your own enterprise scenario.',
      close: 'Close',
    },
  ...
  skills: {
    ...
    douyinLead: {
      ...
      matchHighIntent: 'Match high-intent leads',
      matchHighIntentHint: 'When enabled, the model judges whether each comment is worth outreach',
      highIntentExamples: 'High-intent examples',
      highIntentExamplesHint: 'Used as model guidance; add your own terms',
      highIntentExamplePlaceholder: 'e.g. any solution?',
      matchTarget: 'Comment match target',
      matchTargetHint: 'Describe which comments to find; the model judges by comment text',
      matchPreset: 'Default category',
      matchPresetHint: 'Click to fill the description and example terms',
      matchPresetHighIntent: 'Interested leads',
      matchPresetHighIntentDesc: 'Match comments asking about price, trial, features, buying channels, contact details, or clearly looking for a solution.',
      matchPresetBadExperience: 'Bad experience users',
      matchPresetBadExperienceDesc: 'Match comments complaining that an existing tool is slow, hard to use, broken, regretted, or worth replacing.',
      matchPresetConsultation: 'Tutorial/function questions',
      matchPresetConsultationDesc: 'Match comments asking how to do something, how to use a feature, whether a function is supported, or needing a tutorial.',
      matchPresetAlternative: 'Alternative/competitor demand',
      matchPresetAlternativeDesc: 'Match comments looking for alternative tools, comparing products, asking for recommendations, or wanting to migrate.',
      matchPresetCustom: 'Custom',
      matchPresetCustomDesc: 'Describe the comment type you want to match; the model will judge by comment text.',
      matchDescription: 'Describe matching comments',
      matchDescriptionHint: 'Be specific; examples are supporting signals',
      matchDescriptionPlaceholder: 'e.g. Match comments asking about price, trial, features, buying channels, or contact info',
      matchExamples: 'Example terms',
      matchExamplesHint: 'Used as model guidance; add your own terms',
      matchExamplePlaceholder: 'e.g. any solution?',
      matchTargetRulePrefix: 'Comment match target: ',
      matchDescriptionRulePrefix: 'Match description: ',
      matchExamplesRulePrefix: 'Reference example terms or similar wording: ',
      matchRuleGuardrail: 'Judge by comment text only; do not use author names; do not match generic likes, bookmarks, passing-by comments, jokes, or comments unrelated to the description.',
