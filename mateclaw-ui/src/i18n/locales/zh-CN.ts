export default {
  ...
  skills: {
    ...
    douyinLead: {
      ...
      matchRules: '评论匹配规则',
      matchHighIntent: '匹配高意向客户',
      matchHighIntentHint: '勾选后由大模型根据评论正文判断是否值得触达',
      highIntentExamples: '高意向示例词',
      highIntentExamplesHint: '作为模型判断参考，可自行添加',
      highIntentExamplePlaceholder: '例如：有没有方案',
      matchTarget: '评论匹配目标',
      matchTargetHint: '描述要找哪些评论，系统会按评论正文语义判断',
      matchPreset: '默认分类',
      matchPresetHint: '点击后自动填充描述和示例词',
      matchPresetHighIntent: '有意向的客户',
      matchPresetHighIntentDesc: '匹配正在咨询价格、试用、功能、购买渠道、联系方式，或明确表达想了解解决方案的评论。',
      matchPresetBadExperience: '体验不好的用户',
      matchPresetBadExperienceDesc: '匹配抱怨现有工具慢、不好用、出错、买后后悔，或表达想换方案的评论。',
      matchPresetConsultation: '求教程/功能咨询',
      matchPresetConsultationDesc: '匹配正在询问怎么做、怎么用、是否支持某功能，或需要教程和落地方法的评论。',
      matchPresetAlternative: '竞品替代需求',
      matchPresetAlternativeDesc: '匹配正在寻找替代工具、比较不同产品、求推荐新方案，或表达想从现有工具迁移的评论。',
      matchPresetCustom: '自定义',
      matchPresetCustomDesc: '描述你希望命中的评论类型，系统会按评论正文语义判断是否匹配。',
      matchDescription: '描述匹配哪些评论',
      matchDescriptionHint: '越具体越稳，示例词只是辅助',
      matchDescriptionPlaceholder: '例如：匹配正在咨询价格、试用、功能、购买渠道或联系方式的评论',
      matchExamples: '示例词',
      matchExamplesHint: '作为模型判断参考，可自行添加',
      matchExamplePlaceholder: '例如：有没有方案',
      matchTargetRulePrefix: '评论匹配目标：',
      matchDescriptionRulePrefix: '匹配描述：',
      matchExamplesRulePrefix: '可参考这些示例词或相近说法：',
      matchRuleGuardrail: '只根据评论正文判断，不要使用作者名称；不要命中与描述无关的泛泛点赞、收藏、路过、开玩笑或无明确需求的评论。',
      keywordMatch: '关键词匹配',
      semanticMatch: '语义匹配',
